import json
# Constante global para el archivo de datos
...
def guardar_tareas():
    """Guarda la lista de tareas actual y el próximo ID en el archivo JSON."""
    datos_a_guardar = {
...
while True:
    ...
    if opcion == "1":
        ...
        guardar_tareas()  # Guardar tareas antes de salir
        print("👋 ¡Hasta pronto!")
        break
    else:
